...
public class FolderLocker extends JFrame {
	...
	public static void main(String[] args)  {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FolderLocker frame = new FolderLocker();
	...
	public FolderLocker() {
		...
		contentPane.setBackground(new Color(255, 90, 50));
		...
		lock.setFont(new Font("Calibri", Font.BOLD, 24));
		...
		unlock.setForeground(Color.BLUE);
		unlock.setFont(new Font("Calibri", Font.BOLD, 24));
		unlock.setBounds(392, 301, 124, 37);
